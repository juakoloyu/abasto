...
!function() {
    ...
    0 != $tagsinput.length && $tagsinput.tagsinput(), $(".bootstrap-tagsinput").find(".tag").addClass("badge-" + a), 
    ...
    $(window).on("scroll", blackDashboard.checkScrollForTransparentNavbar)), 0 == $full_screen_map.length && 0 == $(".bd-docs").length && $(".navbar-toggler").click(function() {
        $collapse.on("show.bs.collapse", function() {
    ...
    var a = $(this);
    if (1 == blackDashboard.misc.navbar_menu_visible) $html.removeClass("nav-open"), 
    blackDashboard.misc.navbar_menu_visible = 0, setTimeout(function() {
...
var blackDashboard = {
    ...
    checkScrollForTransparentNavbar: debounce(function() {
        $(document).scrollTop() > scroll_distance ? transparent && (transparent = !1, $navbar_color.removeClass("navbar-transparent")) : transparent || (transparent = !0, 
    ...
    initMinimizeSidebar: function() {
        ...
        0 != $(".sidebar-mini").length && (sidebar_mini_active = !0), $(".minimize-sidebar").click(function() {
            1 == sidebar_mini_active ? ($body.removeClass("sidebar-mini"), sidebar_mini_active = !1, 
            blackDashboard.showSidebarMessage("Sidebar mini desactivado...")) : ($body.addClass("sidebar-mini"), 
            sidebar_mini_active = !0, blackDashboard.showSidebarMessage("Sidebar mini activado..."));
