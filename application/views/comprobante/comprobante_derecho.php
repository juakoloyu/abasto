	...
	<thead>
		<tr>
			<th width="60%" style="text-align: center;">
			    ...
			    <h4 class="titulo">MUNICIPIO DE</h4>
			    <h3 class="titulo">PRESIDENCIA ROQUE SAENZ PEÑA</h3>
			    <h4><i>SUBSECRETARIA DE LA SALUD CIUDADANA<br>Y SEGURIDAD ALIMENTARIA</i></h4>

			</th>
			<th width="40%" style="text-align: center;">
				<!--
				<h4>"1816 BICENTENARIO DE LA <br> INDEPENDENCIA NACIONAL 2016"</h4>-->
				<h3 class="titulo">RECIBO OFICIAL DE PAGO</h3>
				<h4 class="titulo">REINSPECCIÓN - ABASTO - INTRODUCCIÓN</h4>
				<h4>Recibo Nº <?php echo $cabecera->numero_recibo?></h4>
...
<table width="100%" border="1">
	...
	<tbody>
		<?php foreach($datos_liquidacion as $i => $dl){ ?>
				<?php if($i < 1){ ?>
					<tr>
						<td width="2%" rowspan="7"> <span class="texto-vertical">PAGOS</span></td>
				...
				<?php } else{ ?>
					<?php if($dl->id == 36 AND $dl->id_multieje == null){ ?>
						<tr>
							<td width="68%">Camiones (Con rodados individuales)</td>
							<td style="text-align: center;"></td>
							<td style="text-align: center;"></td>
							<td style="text-align: center;"></td>
						</tr>
						<tr>
							<td width="68%">Camiones (Con rodados dobles)</td>
							<td style="text-align: center;"></td>
							<td style="text-align: center;"></td>
							<td style="text-align: center;"></td>
						</tr>
...
<div class="firma">
  	<h4 style="text-align: center;">ESPACIO EXCLUSIVO PARA EL<br>SELLO PARA LA CAJA</h4>
</div>
<style type="text/css">
